...
// Sub-components (Defined at top to avoid Temporal Dead Zone issues)
    ...
    <div className="grid grid-cols-12 gap-8">
       <div className="col-span-12 xl:col-span-8 space-y-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
             ...
             <KpiCard label="Tasks Completed" val={`${completedTasks} / ${safeTasks.length}`} color="emerald" />
       ...
       <div className="col-span-12 xl:col-span-4 space-y-8">
          <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl">
             ...
             <div className="space-y-6">
                <HealthRow label="Schedule Velocity" val={safeTasks.length ? `${Math.round((completedTasks/safeTasks.length)*100)}%` : '0%'} />
...
const RequirementsTab = ({ requirements = [] }) => (
  <div className="bg-white rounded-[3rem] border border-slate-200/60 p-10">
     ...
     <div className="space-y-4">
        ...
        {(!requirements || requirements.length === 0) && <div className="text-center py-20 opacity-20"><Target size={48} className="mx-auto mb-2"/><p className="text-xs font-black uppercase">No clauses defined</p></div>}
     </div>
  </div>
);
